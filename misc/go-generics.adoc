...
The instantiation and usage is like the previous example with `constraints.Ordered`.

== Instantiation examples

It is possible to instantiate the generic function with a concrete type and store the result in another variable:
