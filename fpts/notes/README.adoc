...
A type like `number` is a set where the infinite set of numbers can be assigned to.
...
And operations can be applied to values depending on the type of those values.
