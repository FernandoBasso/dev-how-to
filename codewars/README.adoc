...
Gitlab renders Asciidoctor link:https://asciidoctor.org/docs/user-manual/#enriching-your-content[Math Symbols^] properly. Github does not. For that reason, one may wish to link:https://gitlab.com/programming-studies/programming-how-to[read the examples on the Gitlab repo instead].
